CREATE OR REPLACE FUNCTION public.converter_iniciativa_para_microprocesso(_iniciativa_id uuid, _destino_iniciativa_id uuid)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.converter_iniciativa_para_microprocesso(uuid, uuid) TO authenticated;
